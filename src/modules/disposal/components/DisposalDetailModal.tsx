...
export function DisposalDetailModal({ disposal, onClose }: DisposalDetailModalProps) {
  if (!disposal) return null

  return (
    <AppModal isOpen={!!disposal} onClose={onClose} title="Detail Usulan Penghapusan">
      <div className="space-y-6 pt-3">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {disposal.workflowInstance?.approvals.map((app: any) => {
              let Icon = HelpCircle
        ...
        <div className="flex justify-between items-center pt-4 border-t border-border">
          {disposal.dokumen_path ? (
            <a
              href={disposal.dokumen_path}
              target="_blank"
